...
RASTER_NASA_COASTLINE = '/net/expertise2/mpc/NASA_tiff_distance_to_coast_converted_v2.nc'
DIR_INPUT = '/net/expertise2/mpc/ECE/sample_esl_products'
INPUT_FILES = os.path.join(DIR_INPUT,
                           '%s_wv_ocean_calibration_CMOD5n_ecmwf0125_windspeed_weighted_slc_level1_20150101_today_runv16.nc')
...
OUTPUTDIR_KPI_1D = '/home/datawork-cersat-public/cache/project/mpc-sentinel1/analysis/s1_data_analysis/kpi/kpi_1d'
OUTPUTDIR_KPI_1B = '/net/expertise2/mpc/ECE/kpi-1b/v2percentile95'
